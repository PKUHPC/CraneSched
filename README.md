...
[2025/11/11] 发布 v1.1.3，新增分区默认/最大内存配置、多 GID 支持，优化作业脚本权限与资源管理，完善英文文档及多语言，提升性能与稳定性。
...
**Craned**是部署在计算节点上的守护进程，主要用来监控节点资源及作业状态，接受用户的各种指令，并将其发送给 Cranectld，并向用户传送 Cranectld 的返回结果。

![Architecture](./docs/images/Architecture.png)

具体的架构设计请参考 [CraneSched 文档](https://pkuhpc.github.io/CraneSched/deployment/index.html)。

关于容器功能的设计与实现，请参考 [CraneSched 容器功能介绍](https://pkuhpc.github.io/CraneSched/reference/container/index.html)。
