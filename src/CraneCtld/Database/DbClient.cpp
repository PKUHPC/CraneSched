...
bool MongodbClient::FetchJobRecords(
  ...
  // 55 array_max_concurrent requeue_count
  try {
...
MongodbClient::document MongodbClient::JobInEmbeddedDbToDocument_(
  ...
  // 55 array_max_concurrent requeue_count
  // clang-format off
  std::array<std::string, 57> fields{
    // 0 - 4
    ...
    // 55 - 56
    "array_max_concurrent", "requeue_count"
  };
  // clang-format on
  ...
  std::tuple<int32_t, job_db_id_t, int64_t, bool, std::string,      /*0-4*/
      ...
      values{
          ...
          // 55-56
          array_spec_fields.max_concurrent, runtime_attr.requeue_count()};
