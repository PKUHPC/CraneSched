...
class Cgroup {
 public:
  ...
  bool SetDeviceLimit(uint64_t device_type,std::vector<uint64_t> device_index,bool allow,bool read,bool write,bool mknod);
  bool SetDeviceDeny(uint64_t device_type,std::vector<uint64_t> device_index);
