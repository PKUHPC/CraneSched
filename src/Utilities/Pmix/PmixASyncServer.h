...
class PmixASyncServiceImpl final : public Pmix::CallbackService {
public:
  PmixASyncServiceImpl() = default;
...
public:
  explicit PmixASyncServer() = default;
...
private:
  std::unique_ptr<PmixASyncServiceImpl> m_service_impl_;
